...
class CreateRegulationsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('regulations', function (Blueprint $table) {
            ...
            $table->string('regulation_type_ar');
            $table->string('regulation_type_en');
            $table->string('regulation_name_ar');
            $table->string('regulation_name_en');
            $table->string('article_text_ar');
            $table->string('article_text_en');
            $table->string('attachment')->nullable();
            $table->integer('regulation_year');
            $table->integer('regulation_number');

                    ...
                    <div class="accordion" id="accordionwithicon">
                        <div class="card">
                            <div class="card-header" id="headingOneicon">
                                <h2 class="mb-0">
                                <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapseOneicon" aria-expanded="true" aria-controls="collapseOneicon"><i class="ri-award-line mr-2"></i>First title goes here</button>
                                </h2>
                            </div>
                    ...
                    <div class="accordion" id="accordionwithicon2">
                        <div class="card">
                            <div class="card-header" id="headingOneicon2">
                                <h2 class="mb-0">
                                <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapseOneicon2" aria-expanded="true" aria-controls="collapseOneicon2"><i class="ri-award-line mr-2"></i>First title goes here</button>
                                </h2>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-header" id="headingTwoicon2">
                                <h2 class="mb-0">
                                <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseTwoicon2" aria-expanded="false" aria-controls="collapseTwoicon2"><i class="ri-calendar-line mr-2"></i>Second title goes here</button>
                                </h2>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-header" id="headingThreeicon2">
                                <h2 class="mb-0">
                                <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseThreeicon2" aria-expanded="false" aria-controls="collapseThreeicon2"><i class="ri-drop-line mr-2"></i>Third title goes here</button>
                                </h2>
                            </div>

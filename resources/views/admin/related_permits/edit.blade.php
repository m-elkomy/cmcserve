                ...
                <div class="card m-b-30">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            {!! Form::open(['url'=>aurl('related/permits/'.$related_permits->id),'method'=>'put']) !!}
                                <div class="form-group">
                                    {!! Form::label('permits_name',trans('admin.permits_name')) !!}
                                    {!! Form::select('permits_name',App\model\Permits::pluck('permits_name_en','id'),$related_permits->permits_id,['class'=>'form-control border-info reg_id']) !!}
                                </div>
                                <div class="form-group">
                                    {!! Form::label('related_permits',trans('admin.related_permits_name')) !!}

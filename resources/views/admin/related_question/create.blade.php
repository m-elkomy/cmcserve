                ...
                <div class="card m-b-30">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            {!! Form::open(['url'=>aurl('related/question')]) !!}
                                <div class="form-group">
                                    {!! Form::label('question_en',trans('admin.question_en')) !!}
                                    {!! Form::select('question_en',App\model\AssessmentQuestion::pluck('question_en','id'),old('question_en'),['class'=>'form-control border-info reg_id']) !!}
                                </div>
                                <div class="form-group">

...
<head>
    ...
    <title>{{trans('admin.Reset Password')}}</title>
    <!-- Fevicon -->
                            ...
                            <div class="card-body">
                                ...
                                <form method="post">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="username" placeholder="{{trans('admin.Email')}}" name="email" required value="{{$data->email}}">
                                    </div>
                                    <div class="form-group">
                                        <input type="password" class="form-control" id="password" placeholder="{{trans('admin.Password')}}" name="password"  required>
                                    </div>
                                    <div class="form-group">
                                        <input type="password" class="form-control" id="password" placeholder="{{trans('admin.Password_Confirmation')}}" name="password_confirmation"  required>
                                    </div>
                                    <button type="submit" class="btn btn-success btn-lg btn-block font-18">{{trans('admin.Reset Password')}}</button>
                                </form>
                            </div>
                        </div>
                    </div>

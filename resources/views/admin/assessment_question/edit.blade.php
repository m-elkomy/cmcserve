                ...
                <div class="card m-b-30">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            {!! Form::open(['url'=>aurl('question/'.$question->id),'method'=>'put']) !!}
                            <div class="form-group">
                                {!! Form::label('question_ar',trans('admin.question_name_ar')) !!}
                                {!! Form::text('question_ar',$question->question_ar,['class'=>'form-control border-info reg_id']) !!}
                            </div>
                            <div class="form-group">
                                {!! Form::label('question_en',trans('admin.question_name_en')) !!}
                                {!! Form::text('question_en',$question->question_en,['class'=>'form-control border-info reg_id']) !!}
                            </div>
                            <div class="form-group">
                                {!! Form::label('answer_ar',trans('admin.answer_ar')) !!}
                                {!! Form::text('answer_ar',$question->answer_ar,['class'=>'form-control border-info reg_id']) !!}
                            </div>
                            <div class="form-group">
                                {!! Form::label('answer_en',trans('admin.answer_en')) !!}
                                {!! Form::text('answer_en',$question->answer_en,['class'=>'form-control border-info reg_id']) !!}
                            </div>

                        ...
                        <div class="table-responsive">
                            {!! Form::open(['url'=>aurl('users/'.$user->id),'method'=>'put']) !!}
                                <div class="form-group">
                                    ...
                                    {!! Form::text('name',$user->name,['class'=>'form-control border-info']) !!}
                                </div>
                                <div class="form-group">
                                    {!! Form::label('email',trans('admin.Email')) !!}
                                    {!! Form::email('email',$user->email,['class'=>'form-control border-info']) !!}
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    {!! Form::text('mobile',$user->mobile,['class'=>'form-control border-info']) !!}
                                </div>
                                <div class="form-group">
                                    ...
                                    {!! Form::select('member_type',['gold'=>trans('admin.gold'),'silver'=>trans('admin.silver'),'Platinum'=>trans('admin.Platinum')],
                                        $user->member_type,['class'=>'form-control border-info','placeholder'=>'...............']) !!}
                                </div>
                                <div class="form-group">
                                    {!! Form::label('company',trans('admin.Company')) !!}
                                    {!! Form::text('company',$user->company,['class'=>'form-control border-info']) !!}
                                </div>

                ...
                <div class="card m-b-30">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            {!! Form::open(['url'=>aurl('regulations')]) !!}
                                ...
                                <div class="form-group">
                                    ...
                                    {!! Form::text('regulation_type_ar',old('regulation_type_ar'),['class'=>'form-control border-info']) !!}
                                </div>
                                <div class="form-group">
                                    {!! Form::label('regulation_type_en',trans('admin.regulation_type_en')) !!}
                                    {!! Form::text('regulation_type_en',old('regulation_type_en'),['class'=>'form-control border-info']) !!}
                                </div>
                                <div class="form-group">
                                    {!! Form::label('regulation_name_ar',trans('admin.regulation_name_ar')) !!}
                                    {!! Form::text('regulation_name_ar',old('regulation_name_ar'),['class'=>'form-control border-info']) !!}
                                </div>
                                <div class="form-group">
                                    {!! Form::label('regulation_name_en',trans('admin.regulation_name_en')) !!}
                                    {!! Form::text('regulation_name_en',old('regulation_name_en'),['class'=>'form-control border-info']) !!}
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    {!! Form::text('regulation_year',old('regulation_year'),['class'=>'form-control border-info']) !!}
                                </div>
                                <div class="form-group">
                                    {!! Form::label('regulation_number',trans('admin.regulation_number')) !!}
                                    {!! Form::text('regulation_number',old('regulation_number'),['class'=>'form-control border-info']) !!}
                                </div>
                                <div class="form-group">

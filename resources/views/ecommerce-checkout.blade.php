                                    ...
                                    <section>
                                        ...
                                        <div class="social-login text-center">
                                            <div class="button-list">
                                                <button type="button" class="btn btn-round btn-primary"><i class="ri-facebook-line font-16"></i></button>
                                                <button type="button" class="btn btn-round btn-danger"><i class="ri-google-line font-16"></i></button>
                                            </div>
                                        </div>
                                    ...
                                    <section>
                                        ...
                                        <ul class="nav nav-pills justify-content-center custom-tab-button mb-3" id="pills-tab-button" role="tablist">
                                            <li class="nav-item mr-1">
                                                <a class="nav-link border active" id="pills-card-tab-button" data-toggle="pill" href="#pills-card-button" role="tab" aria-controls="pills-card-button" aria-selected="true"><span class="tab-btn-icon"><i class="ri-bank-card-2-line"></i></span>Card</a>
                                            </li>
                                            <li class="nav-item mr-0">
                                                <a class="nav-link border" id="pills-paypal-tab-button" data-toggle="pill" href="#pills-paypal-button" role="tab" aria-controls="pills-paypal-button" aria-selected="false"><span class="tab-btn-icon"><i class="ri-paypal-fill"></i></span>Paypal</a>
                                            </li>
                                        </ul>

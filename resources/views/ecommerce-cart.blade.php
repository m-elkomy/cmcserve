                        ...
                        <div class="col-lg-10 col-xl-8">
                            <div class="cart-container">
                                ...
                                <div class="cart-footer text-right">
                                    <button type="button" class="btn btn-primary-rgba my-1"><i class="ri-save-line mr-2"></i>Update Cart</button>
                                    <a href="{{url('/page-checkout')}}" class="btn btn-success-rgba my-1">Proceed to Checkout<i class="ri-arrow-right-line ml-2"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>

                    ...
                    <ul class="list-inline mb-0">
                            ...
                            <div class="languagebar">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="languagelink">
                                        <a class="dropdown-item" href="{{aurl('lang/en')}}"><i class="flag flag-icon-us flag-icon-squared"></i>{{trans('admin.English')}}</a>
                                        <a class="dropdown-item" href="{{aurl('lang/ar')}}"><i class="flag flag-icon-de flag-icon-squared"></i>{{trans('admin.Arabic')}}</a>
                        ...
                        <li class="list-inline-item">
                            <div class="profilebar">
                                <div class="dropdown">
                                  <a class="dropdown-toggle" href="#" role="button" id="profilelink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="{{asset('assets/images/users/profile.svg')}}" class="img-fluid" alt="profile"><span class="live-icon">{{admin()->user()->name}}</span></a>
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="profilelink">
                                        ...
                                        <a class="dropdown-item text-danger" href="{{url('admin_panel/logout')}}"><i class="ri-shut-down-line"></i>{{trans('admin.Logout')}}</a>
                                    </div>
                                </div>
                            </div>
                        </li>

            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="col-md-6">
                            <select name="member_type" class="form-control" {{ old('member_type')}}>
                                <option value="free">{{trans('user.free')}}</option>
                                <option value="gold">{{trans('user.gold')}}</option>
                                <option value="silver">{{trans('user.silver')}}</option>
                                <option value="Platinum">{{trans('user.Platinum')}}</option>
                            </select>

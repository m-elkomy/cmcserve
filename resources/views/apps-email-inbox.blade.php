                ...
                <div class="card m-b-30">
                    <div class="card-header">
                        <ul class="list-inline mb-0">
                            <li class="list-inline-item"><a href="#"><i class="ri-checkbox-blank-line font-20"></i></a></li>
                            <li class="list-inline-item"><a href="#"><i class="ri-download-2-line font-20"></i></a></li>
                            <li class="list-inline-item"><a href="#"><i class="ri-spam-line font-20"></i></a></li>
                            <li class="list-inline-item"><a href="#"><i class="ri-delete-bin-3-line font-20"></i></a></li>
                            <li class="list-inline-item"><a href="#"><i class="ri-time-line font-20"></i></a></li>
                            <li class="list-inline-item"><a href="#"><i class="ri-folder-3-line font-20"></i></a></li>
                            <li class="list-inline-item"><a href="#"><i class="ri-price-tag-3-line font-20"></i></a></li>
                            <li class="list-inline-item"><a href="#"><i class="ri-more-2-fill menu-hamburger-vertical font-20"></i></a></li>
                            <li class="list-inline-item float-right"><a href="#"><i class="ri-settings-3-line font-20"></i></a></li>
                        </ul>
                    </div>
                    <div class="card-body">                                    

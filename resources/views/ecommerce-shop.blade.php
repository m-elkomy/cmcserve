                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-3">
                            <ul class="list-inline-group text-right mb-0 pl-0">
                                <li class="list-inline-item mr-0 font-12"><a href="#"><i class="ri-refresh-line font-16 text-primary ml-1"></i></a></li>
                            </ul>                                        
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row align-items-center ecommerce-sortby">
                        ...
                        <div class="col-md-12 col-lg-12 col-xl-8">
                            <div class="button-list">
                                <button type="button" class="btn btn-round btn-primary-rgba"><i class="ri-function-line font-18"></i></button>
                                <button type="button" class="btn btn-round btn-secondary-rgba"><i class="ri-list-check-2 font-18"></i></button>
                            </div>
                        </div>
                         <!-- End col -->
                    </div> 
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-xl-4">
                            <div class="product-bar m-b-30">
                                <div class="product-head">
                                    <a href="#"><img src="assets/images/ecommerce/product_img_01.jpg" class="img-fluid" alt="product"></a>
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-6">
                                            <div class="text-right">
                                                <a href="#" class="btn btn-primary rounded-circle font-18"><i class="ri-shopping-cart-line"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-6 col-xl-4">
                            <div class="product-bar m-b-30">
                                <div class="product-head">
                                    <a href="#"><img src="assets/images/ecommerce/product_img_02.jpg" class="img-fluid" alt="product"></a>
                        ...
                        <div class="col-lg-6 col-xl-4">
                            <div class="product-bar m-b-30">
                                <div class="product-head">
                                    <a href="#"><img src="assets/images/ecommerce/product_img_03.jpg" class="img-fluid" alt="product"></a>
                        ...
                        <div class="col-lg-6 col-xl-4">
                            <div class="product-bar m-b-30">
                                <div class="product-head">
                                    <a href="#"><img src="assets/images/ecommerce/product_img_04.jpg" class="img-fluid" alt="product"></a>
                        ...
                        <div class="col-lg-6 col-xl-4">
                            <div class="product-bar m-b-30">
                                <div class="product-head">
                                    <a href="#"><img src="assets/images/ecommerce/product_img_05.jpg" class="img-fluid" alt="product"></a>
                        ...
                        <div class="col-lg-6 col-xl-4">
                            <div class="product-bar m-b-30">
                                <div class="product-head">
                                    <a href="#"><img src="assets/images/ecommerce/product_img_06.jpg" class="img-fluid" alt="product"></a>

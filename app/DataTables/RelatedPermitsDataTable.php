...
use DB;
class RelatedPermitsDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables($query)
            ->addColumn('edit', 'admin.related_permits.btn.edit')
            ->addColumn('delete', 'admin.related_permits.btn.delete')
            ->addColumn('checkbox', 'admin.related_permits.btn.checkbox')
            ->rawColumns([
                'edit',
                'delete',
                'checkbox',
...
//            return $all;
        ...
        return RelatedPermits::query()->with(['permits','reg_permits'])->select('related_permits.*');
//         Regulations::query()->with('related_regulations')->select('regulations.*');
    ...
    protected function getColumns()
    {
        return [
            ...
            [
                'name'=>'reg_permits.permits_name_en',
                'data'=>'reg_permits.permits_name_en',
                'title'=>trans('admin.permits_name')
            ],
            [
                'name'=>'permits.permits_name_en',
                'data'=>'permits.permits_name_en',
                'title'=>trans('admin.related_permits_name')
            ],
    ...
    {
        return 'RelatedPermits_' . date('YmdHis');
    }
}
